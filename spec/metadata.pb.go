...
var file_protos_metadata_proto_goTypes = []any{
...
func file_protos_metadata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_protos_metadata_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_protos_metadata_proto_msgTypes[1].Exporter = func(v any, i int) any {
